# 项目简介
本项目旨在通过VR头显提供机械臂末端坐标实现aloha眼睛臂的实时控制，底层代码函数通过Pinocchio+Casadi的组合实现机械臂位置实时求解，从而实现实物机械臂的控制
...
sudo apt update && sudo apt install -y \
    ...
    libavutil-dev libswscale-dev libswresample-dev libv4l-dev \
    libopus-dev libvpx-dev pkg-config android-tools-adb
